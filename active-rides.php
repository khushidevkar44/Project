...
<div class="sidebar-item">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Active Rides</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Drivers Online</p>
                    <h4 class="mb-0">95</h4>
                </div>
            ...
            <table class="table table-dark table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Vesu</td>
                        <td>₹240</td>
                        <td><span class="badge bg-primary">On Trip</span></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>Airport</td>
                        <td>₹390</td>
                        <td><span class="badge bg-info">Driver Arriving</span></td>
                        <td>
                            <button class="btn btn-sm btn-primary">
                                <i class="bi bi-eye"></i>
                            </button>
                    ...
                    <tr>
                        ...
                        <td>Ring Road</td>
                        <td>₹180</td>
                        <td><span class="badge bg-success">Ride Started</span></td>
                        <td>
                            <button class="btn btn-sm btn-primary">
                                <i class="bi bi-eye"></i>
                            </button>
