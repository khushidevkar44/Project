...
style="background:linear-gradient(135deg,#7c3aed,#9333ea);color:#fff;border-radius:16px;">
...
<h2 class="fw-bold mb-2">📄 Documents</h2>
...
<td><button class="btn btn-sm btn-warning"><i class="bi bi-upload"></i></button></td>
...
<td><button class="btn btn-sm btn-danger"><i class="bi bi-arrow-repeat"></i></button></td>
