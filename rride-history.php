...
View all your completed rides, fare details, invoices and ratings in one place.
</p>

<a href="book-ride.php" class="btn btn-light px-4">
...
<i class="bi bi-clock-history text-white"
...
<i class="bi bi-signpost-split-fill text-primary fs-1"></i>
...
type="text"
class="form-control"
placeholder="Ride ID / Driver Name">
