...
<div class="sidebar-item">
    ...
    <div class="page-heading">
        ...
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    View and manage uploaded vehicle documents.
                </p>
        ...
        <div class="heading-actions">
            ...
            <a href="cars.php" class="btn btn-secondary btn-sm">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">RC Uploaded</p>
                    <h4 class="mb-0">790</h4>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Insurance Uploaded</p>
                    <h4 class="mb-0">770</h4>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Pending Documents</p>
                    <h4 class="mb-0">40</h4>
                </div>
