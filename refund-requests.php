        ...
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    Manage customer refund requests and refund status.
                </p>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-1">Refund Requests</p>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-1">Approved Refunds</p>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-1">Rejected Refunds</p>

                    <h4 class="mb-0">8</h4>

                </div>

                <i class="bi bi-x-circle-fill fs-1 text-primary"></i>
