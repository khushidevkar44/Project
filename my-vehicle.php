...
style="background:linear-gradient(135deg,#0f766e,#14b8a6);color:#fff;border-radius:16px;">
...
<h2 class="fw-bold mb-2">🚗 My Vehicle</h2>
...
<input class="form-control" value="Maruti Suzuki Dzire">
...
<input class="form-control" value="GJ05AB1234">
...
<input class="form-control" value="Sedan">
...
<input class="form-control" value="White">
...
<input class="form-control" value="2024">
...
<input class="form-control" value="Petrol">
