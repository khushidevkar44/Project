...
<div class="sidebar-item">
    ...
    <div class="page-heading-copy">
        ...
        <div>
            ...
            <h1 class="h3 mb-1">All Drivers</h1>
            <p class="text-muted mb-0">
                Manage all registered drivers on the RideHub platform.
            </p>
        </div>
    </div>

    <div class="heading-actions">
        <a href="add-driver.php" class="btn btn-primary btn-sm">
            <i class="bi bi-person-plus"></i>
            Add Driver
        </a>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card shadow-sm">
            <div class="card-body">
                <h6>Total Drivers</h6>
                <h2>120</h2>
                <small class="text-success">+8 New Drivers</small>
            </div>
        </div>
    </div>
...
</section><div class="d-flex justify-content-end mt-3">
