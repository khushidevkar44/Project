        ...
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    Configure RideHub application settings and preferences.
                </p>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted mb-1">Email Service</p>

                    <h4 class="mb-0">Active</h4>

                </div>

                <i class="bi bi-envelope-check-fill fs-1 text-warning"></i>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <h4 class="mb-0">Updated</h4>

                </div>

                <i class="bi bi-cloud-check-fill fs-1 text-info"></i>
        ...
        <form>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <label class="form-label">Ride Commission (%)</label>
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control"
                              rows="4">Surat, Gujarat, India</textarea>
