...
<div class="sidebar-item">
        ...
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    View and manage cancelled ride requests.
                </p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Cancelled Rides</p>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Cancelled Today</p>
                    <h4 class="mb-0">18</h4>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Customer Cancelled</p>
                    <h4 class="mb-0">120</h4>
                </div>
                <i class="bi bi-person-x-fill fs-1 text-primary"></i>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Driver Cancelled</p>
                    <h4 class="mb-0">65</h4>
                </div>
            ...
            <table class="table table-dark table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Amit Shah</td>
                        <td>Rakesh Kumar</td>
                        <td><span class="badge bg-secondary">Driver</span></td>
                        <td>Vehicle Issue</td>
