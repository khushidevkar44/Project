...
<div class="sidebar-item">
    ...
    <div class="page-heading">
        ...
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <p class="text-muted mb-0">
                    Manage all registered cars on the RideHub platform.
                </p>
        ...
        <div class="heading-actions">
            ...
            <a href="add-vehicle.php" class="btn btn-primary btn-sm">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Verified Cars</p>
                    <h4 class="mb-0">480</h4>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Pending Cars</p>
                    <h4 class="mb-0">28</h4>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card shadow-sm border-0">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <p class="text-muted mb-1">Blocked Cars</p>
                    <h4 class="mb-0">12</h4>
                </div>
